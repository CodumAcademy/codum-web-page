  ...
  faqs: [
    {
      ...
      <br />
      <p>Priorizamos la participación de estudiantes de estratos 2 y 3 que demuestren un excelente desempeño académico y que puedan asumir el reto de formación que implica el programa.</p>
      `
    },
    {
      id: 2,
    ...
    {
      id: 5,
      question: "¿CUÁL ES EL HORARIO DEL PROCESO DE FORMACIÓN?",
      answer: `<p>Con el propósito de garantizar la permanencia de los estudiantes en la universidad, nuestro programa se oferta en jornadas al iniciar el día o en la noche, de este modo los horarios habituales de trabajo o educación superior se mantienen disponibles para otras actividades.</p>`
    },
    {
      id: 6,
      question:
